...
public class KarlsonWallRunningVR : MonoBehaviour
{
    [Header("Assignables")]
    ...
    public static KarlsonWallRunningVR Instance { get; private set; }
    ...
    private void Movement()
    {
        ...
        // one of my favorite parts of this...crouching in vr though? headset position?
